    ...
    <q-card flat bordered class="filters-card">
      ...
      <q-card-section class="q-pa-md">
        <div class="row q-col-gutter-md items-center">
          ...
          <div class="col-12 col-md-3">
            <q-select
              v-model="localFilters.expiredFilter"
              outlined
              dense
          ...
          <div
            ...
            v-if="localFilters.expiredFilter === 'custom'">
            <q-input
              v-model.number="localFilters.customDays"
              outlined
              dense
              type="number"
              label="Giorni"
        ...
        <div class="row q-mt-sm" v-if="totalOrders > 0">
          <div class="col-12">
            <q-chip color="primary" text-color="white" icon="info">
              {{ totalOrders }}
              {{ totalOrders === 1 ? "ordine trovato" : "ordini trovati" }}
            </q-chip>
          </div>
        </div>
      </q-card-section>
            ...
            <div class="row q-col-gutter-md">
              ...
              <div class="col-12">
                ...
                <div class="row q-col-gutter-sm">
                  <div class="col-12 col-md-3">
                    <q-input
                      v-model="localFilters.clientLastname"
                      outlined
                      dense
                      label="Cognome"
                      clearable />
                  ...
                  <div class="col-12 col-md-3">
                    <q-input
                      v-model="localFilters.clientFirstname"
                      outlined
                      dense
                      label="Nome"
                      clearable />
                  ...
                  <div class="col-12 col-md-2">
                    <q-input
                      v-model="localFilters.clientCity"
                      outlined
                      dense
                      label="Città"
                      clearable />
                  ...
                  <div class="col-12 col-md-2">
                    <q-input
                      v-model="localFilters.clientCountry"
                      outlined
                      dense
                      label="Paese"
                      clearable />
                  ...
                  <div class="col-12 col-md-2">
                    <q-select
                      v-model="localFilters.clientVip"
                      outlined
                      dense
                      :options="vipOptions"
                      label="VIP"
              ...
              <div class="col-12 col-md-4">
                <q-input
                  v-model="localFilters.productCode"
                  outlined
                  dense
