<template>
  <div class="invoice-edit-container">
    ...
    <!-- ARTICOLI FULL WIDTH -->
    <div class="q-mt-md">
      <InvoiceItems v-model:items="invoiceData.items" @update:taxable="handleTaxableUpdate"
...
const handleBack = () => {
  ...
  const orderIdValue = invoiceData.invoiceData.orderId?._id || invoiceData.invoiceData.orderId
