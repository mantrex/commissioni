          ...
          <q-table
            ...
            <template v-slot:body-cell-selectable="props">
              <q-td :props="props" class="text-center">
                <q-badge
                  :color="props.row.selectable ? 'positive' : 'grey-5'"
                  :label="props.row.selectable ? 'Attivo' : 'Disattivo'" />
              </q-td>
            </template>
            ...
            <template v-slot:body-cell-deleted="props">
              <q-td :props="props" class="text-center">
                <q-badge
                  :color="!props.row.deleted ? 'positive' : 'grey-5'"
                  :label="!props.row.deleted ? 'Attivo' : 'Disattivo'" />
              </q-td>
            </template>
